...
static NSString *foldName = @"VTERFold";
static NSString *sqliteName = @"vter1.sqlite";
...
+ (NSString *)dbPathWithDirectoryName:(NSString *)directoryName
{
    ...
    if (directoryName == nil || directoryName.length == 0) {
        docsdir = [docsdir stringByAppendingPathComponent:foldName];
    } else {
    ...
    NSString *dbpath = [docsdir stringByAppendingPathComponent:sqliteName];
    return dbpath;
}
